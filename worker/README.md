...
2. Common connections such as MySQL Database or Redis memory cache always keep the connection as default, so that you could create connect at first then use the connection to operate continuously.
